...
- **O construtor mudou.** Citizen developers (quem builda com IA sem ser dev) vão superar os programadores profissionais **4 pra 1**. `[27:25]`
- **O last mile precisa dos pares.** *"Solo producers get to ~80%, then need help to go into production, scale, go-to-market… like guilds, with specialties."* `[48:26]`
