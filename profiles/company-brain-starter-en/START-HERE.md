...
This folder is your Company Brain. It lives on your computer. Manus Desktop, Codex, Claude, Gemini
or another file-based AI can operate it, but the files remain the durable memory.

## Activate it

1. Put 2–4 small, real files about **one recurring operation** in `raw/`. Redact personal or
   confidential data you would not share with your AI provider.
2. Open this folder with your AI. In Manus Desktop: **My Computer → Add folder → choose this
   folder**.
3. Paste:

> Read `START-HERE.md`, `AGENTS.md`, and `skills/company-brain-sprint/SKILL.md`. Activate one
> evidence-backed operating slice from the files in `raw/`. Save every durable output using
